...
// Switches thread to SCHED_FIFO real-time scheduling class, will run until it
// blocks or yields, won't get descheduled by a normal class thread
bool SetRealtimePriority(int priority) noexcept;

// Pin all current and future pages of the process into RAM -> no later page
// faults
